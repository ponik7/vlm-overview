...
class NN(object):
    ...
    def prepare(self):
        ...
        if self.is_train and config.fc_kernel_regularizer_scale > 0:
            self.fc_kernel_regularizer = tf.keras.regularizers.l2(
        ...
        if self.is_train and config.fc_activity_regularizer_scale > 0:
            self.fc_activity_regularizer = tf.keras.regularizers.l1(
